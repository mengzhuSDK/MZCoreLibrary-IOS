Pod::Spec.new do |s|
  ...
  s.frameworks = 'Foundation', 'AVFoundation', 'QuartzCore', 'OpenGLES', 'CoreVideo', 'CoreMedia', 'AssetsLibrary', 'UIKit', 'Security', 'JavaScriptCore', 'WebKit', 'MapKit', 'MobileCoreServices', 'SystemConfiguration', 'Photos', 'CoreServices', 'AudioToolbox'
